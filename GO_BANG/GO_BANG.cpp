...
Game_Application application(BOARD_ROW_SIZE, BOARD_COL_SIZE, PLAYER_VS_PLAYER);			//游戏对象实例化
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND:
        ...
        break;
	case WM_LBUTTONUP:
		application.TheLeftMouseChick(hWnd, LOWORD(lParam), HIWORD(lParam));
		break;
    case WM_PAINT:
        {
            PAINTSTRUCT ps;
